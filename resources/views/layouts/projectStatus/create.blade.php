	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Create New Project Status</div>
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="{{ url('projectStatus/store') }}">
						{!! csrf_field() !!}
						...
						<div class="form-group{{ $errors->has('abv') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="abv" value="{{ old('abv') }}">
								@if ($errors->has('abv'))
									<span class="help-block">
